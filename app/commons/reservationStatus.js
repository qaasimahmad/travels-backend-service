																						...
																						<div
																							...
																							<div
																								...
																								<p
																									...
																									Thank You!,<br>
																									We are happy to be of service to you. Reservation is valid till the return Date specified.<br>
																									kindly check your Reservation Details below.<br>
																								</p>
																						...
																						<div
																							...
																							<div
																								...
																								<p
																									...
																									FullName&nbsp;
																									<strong
																										style="float: right">${userData.fullName}</strong>
																									<br />
																								</p>
																								...
																								<p
																									...
																									Origin&nbsp;
																									<strong
																										style="float: right">${userData.from}</strong>
																									<br />
																								</p>
                                                                                                ...
                                                                                                <p
																									...
																									Destination&nbsp;
																									<strong
																										style="float: right">${userData.to}</strong>
																									<br />
																								</p>
                                                                                                ...
                                                                                                <p
																									...
																									ReturnDate&nbsp;
																									<strong
																										style="float: right">${userData.returnDate}</strong>
																									<br />
																								</p>
                                                                                                ...
                                                                                                <p
																									...
																									Adults&nbsp;
																									<strong
																										style="float: right">${userData.adults}</strong>
																									<br />
																								</p>
																								...
																								<p
																									...
																									Children&nbsp;
																									<strong
																										style="float: right">${userData.children}</strong>
																									<br />
																								</p>
																								...
																								<p
																									...
																									Infants&nbsp;
																									<strong
																										style="float: right">${userData.infants}</strong>
																									<br />
																								</p>
                                                                                                ...
                                                                                                <p
																									...
																									Reservation ID&nbsp;
																									<strong
																										style="float: right">${userData.reservationId}</strong>
																									<br />
																								</p>
